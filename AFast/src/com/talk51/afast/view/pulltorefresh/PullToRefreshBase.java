...
import com.talk51.afast.view.pulltorefresh.internal.FlipLoadingLayout;
import com.talk51.afast.view.pulltorefresh.internal.HeadLoadingLayout;
import com.talk51.afast.view.pulltorefresh.internal.HeadRotateLoadingLayout;
import com.talk51.afast.view.pulltorefresh.internal.FootRotateLoadingLayout;
import com.talk51.afast.view.pulltorefresh.internal.FootLoadingLayout;
import com.talk51.afast.view.pulltorefresh.internal.Utils;
import com.talk51.afast.view.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private HeadLoadingLayout mHeaderLayout;
...
//            if (mCurrentMode != Mode.PULL_FROM_START || millis < startTime - 100){
	...
	protected FrameLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		FrameLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
	...
	protected final HeadLoadingLayout getHeaderLayout() {
	...
	private void callRefreshListener() {
		if (null != mOnRefreshListener) {
			...
			if (mCurrentMode == Mode.PULL_FROM_START) {
                startTime = SystemClock.uptimeMillis()+1500;
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mHeaderLayout = (HeadLoadingLayout)createLoadingLayout(context, Mode.PULL_FROM_START, a);
		mFooterLayout = (FootLoadingLayout)createLoadingLayout(context, Mode.PULL_FROM_END, a);
	...
	public static enum AnimationStyle {
		...
		FrameLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				case ROTATE:
				default:
                    if (Mode.PULL_FROM_START == mode){
                        return new HeadRotateLoadingLayout(context, mode, scrollDirection, attrs);
                    }else if (Mode.PULL_FROM_END== mode){
                        return new FootRotateLoadingLayout(context, mode, scrollDirection, attrs);
                    }
				case FLIP:
